...
import 'package:onpensea/CheckoutRegisterProperty/Screens/InitiatingPaymentScreen.dart';
...
class CheckoutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // double tokenprice = double.parse( != null ? tokenPrice! : "");
    // double tokencount = double.parse(tokenCount != null ? tokenCount! : "");
    int total = 20;
        ...
        SliverAppBar(
          ...
          title: Row(
            children: [
              ...
              Expanded(
                  child: Text(
                payToName.length < 16 ? '$payToName ' : payToName,
    ...
    return ElevatedButton(
      ...
      onPressed: () => {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => InitiatingPaymentScreen(
