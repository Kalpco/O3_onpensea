...
//   bool _isWalletRedeemable = false;
//   bool _isRedeemChecked = false;
//   bool _isNotRedeemChecked = true;
//
//   @override
//   void initState() {
//     super.initState();
...
//   }
//
//   Future<void> _createOrder(BuildContext context, double updatedTotalPrice) async {
//     if (updatedTotalPrice <= 0.00) {
//       // Wallet payment process logic
//     } else {
//       try {
//         // Razorpay payment process logic
//       } catch (e) {
...
//     try {
//       int userId = loginController.userData['userId'];
//       final url = Uri.parse("http://o3uat.kalpco.in/users/kalpco/v1.0.0/users/$userId");
