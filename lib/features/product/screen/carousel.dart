...
//   void initState() {
//     super.initState();
//     _videoController = VideoPlayerController.asset('assets/gold/Kalpco.mp4')
//       ..initialize().then((_) {
...
//
//     _carouselItems = [
//       Image.asset('assets/gold/rings.jpg', fit: BoxFit.cover),
//       Image.asset('assets/gold/angles.jpg', fit: BoxFit.cover),
//        Image.asset('assets/gold/rings.jpg', fit: BoxFit.cover),
//
//       _buildVideoPlayer(),
//     ];
