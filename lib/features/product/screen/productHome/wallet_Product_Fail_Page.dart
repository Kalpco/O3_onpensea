...
class WalletProductFailPage extends StatelessWidget {
  String orderId;
  // ProductResponseDTO product;
  double totalPrice;

  WalletProductFailPage({super.key,required this.orderId,required this.totalPrice});
                            ...
                            Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  width: MediaQuery.of(context).size.width,
                                  child: Text(
                                    "Message :" + 'Payment failed from wallet',
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold, fontSize: 15),
                                  ),
                                ),
