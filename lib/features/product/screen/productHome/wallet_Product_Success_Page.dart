...
class WalletProductSuccessPage extends StatefulWidget {
  final String orderId;
  // final ProductResponseDTO product;
  final double totalPrice;

  WalletProductSuccessPage({
    Key? key,
  ...
  @override
  _WalletProductSuccessPageState createState() => _WalletProductSuccessPageState();
}
                            ...
                            Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  width: MediaQuery.of(context).size.width,
                                  child: Text(
                                    "Rs.${widget.totalPrice.toStringAsFixed(2)} redeemed from your wallet",
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15,
                                    ),
