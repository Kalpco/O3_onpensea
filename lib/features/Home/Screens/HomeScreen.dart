...
//           '${ApiConstants.USERS_URL}/pictures?userType=U');
//
...
//             imgList = [
//               fetchedImages[3], // First image
//               fetchedImages[3], // Fourth image
//               fetchedImages[9],
//               fetchedImages[9], // Seventh image
//             ];
//
...
//               height: 50,
//             ),
//             // Lab Grown Diamond - New Second Section
//             // Lab Grown Diamond - New Second Section
//             Row(
...
//                       ? buildImage(diamondCollectionImages[0]) // Show the image if available
//                       : Container(), // Show an empty container if the image is not available
//                 ),
//               ),
//               onTap: () {
//                 Navigator.push(
...
import 'package:google_fonts/google_fonts.dart';
import 'package:onpensea/commons/config/api_constants.dart';
import 'package:onpensea/features/lservice/screens/LScreen.dart';
import 'package:onpensea/features/product/screen/productHomeAppBar/common_top_bar.dart';
import 'package:onpensea/features/scheme/Screens/all_scheme_screen.dart';
import 'package:onpensea/navigation_menu.dart';
import 'package:shimmer/shimmer.dart';
