...
import '../screen/customProductSubCategoryDetailPage.dart';
import 'adminCustomProductSubCategoryDetailPage.dart';


class AdminCustomProductSubCategory extends StatefulWidget {
  final String? productSubCategory;

  AdminCustomProductSubCategory({required this.productSubCategory});


  @override
  State<AdminCustomProductSubCategory> createState() => _AdminCustomProductSubCategoryState();
}

class _AdminCustomProductSubCategoryState extends State<AdminCustomProductSubCategory> {
  @override
  ...
  void _handleTap(BuildContext context, String param) async {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminCustomProductSubcategoryDetailPage(productSubCategory: param),)
    );
