class Properties {
  ...
  final String propExpiredDate;
  final String shootingStart;
  ...
  Properties({required this.id,
    ...
    required this.propExpiredDate,
    required this.shootingStart,
...
required this.movieType
  ...
  factory Properties.fromJson(Map<String, dynamic> json) {
    ...
    return Properties(
      ...
      propExpiredDate:json['propExpiredDate']??'NA',
      shootingStart:json['shootingStart']??'NA',
      directorName: json['directorName']??'NA',
      actorName: json['actorName']??'NA',
      actressName: json['actressName']??'NA',
