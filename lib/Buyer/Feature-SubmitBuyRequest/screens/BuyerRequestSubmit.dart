...
import '../../../Property/Feature-ShowAllDetails/Screens/PropertyDetailsScreenNew.dart';

enum AppbarActionType { leading, trailing }

class BuyerRequestSubmit extends StatefulWidget {
  final String screenStatus;
  final Properties prop;
  final String tokenRequested;
  final String remarks;

  const BuyerRequestSubmit(
      {super.key,
  ...
  State<StatefulWidget> createState() {
    return _BuyerRequestSubmitState();
  }
}

class _BuyerRequestSubmitState extends State<BuyerRequestSubmit> {
  Future<String>? msg;
  late String res;
  ...
  void initState() {
    ...
    super.initState();
    msg = BuyerController.postTheBuerRequest(
