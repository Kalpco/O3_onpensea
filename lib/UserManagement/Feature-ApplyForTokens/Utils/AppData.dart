...
import 'package:onpensea/UserManagement/Feature-ApplyForTokens/Models/product_category.dart';
import 'package:onpensea/UserManagement/Feature-ApplyForTokens/Models/product_size_type.dart';
import 'package:onpensea/UserManagement/Feature-ApplyForTokens/Models/recommended_product.dart';
...
class AppData {
  ...
  static List<RecommendedProduct> recommendedProducts = [
    ...
    RecommendedProduct(
        title: "Sell",
        imagePath: "",
        cardBackgroundColor: const Color(0xFF9C46FF),
        buttonBackgroundColor: const Color(0xFFEC6813),
        buttonTextColor: Colors.white,
        category: "sell"),
  ];
}
