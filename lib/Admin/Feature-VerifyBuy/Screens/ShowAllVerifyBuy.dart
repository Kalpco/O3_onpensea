...
import 'package:onpensea/Admin/Feature-VerifyBuy/Controller/BuyController.dart';
...
class ShowAllVerifyBuy extends StatefulWidget {
  final String screenStatus;

  const ShowAllVerifyBuy({super.key, required this.screenStatus});

  @override
  State<StatefulWidget> createState() {
    return _ShowAllVerifyBuyViewState();
  }
}

class _ShowAllVerifyBuyViewState extends State<ShowAllVerifyBuy> {
  // late List<Buyer> propList;
  ...
  void initState() {
    ...
    super.initState();
    prop = BuyController.getAllBuyRequests();
    getUsername();
  }
