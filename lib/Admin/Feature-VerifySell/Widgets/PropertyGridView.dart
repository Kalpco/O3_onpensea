...
class PropertyGridView extends StatelessWidget {
  ...
  final List<Seller> props;
  final void Function(int index) likeButtonPressed;
  final String screenStatus;
  final String username;

  Widget _gridItemHeader(Seller prop, int index) {
    return Padding(
  ...
  Widget _gridItemBody(Seller prop) {
    String? bytesList;
  ...
  Widget _gridItemFooter(Seller prop, BuildContext context) {
    return Padding(
