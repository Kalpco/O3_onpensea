...
import '../../../Admin/Feature-VerifyBuy/Screens/ShowIndividualBuyScreen.dart';
...
import '../../Feature-VerifyBuy/Screens/ShowAllVerifyBuy.dart';
import '../../Feature-VerifyProperties/Screens/ShowAllPendingProperties.dart';
...
class ShowAllVerifySell extends StatefulWidget {
  final String screenStatus;

  const ShowAllVerifySell({super.key, required this.screenStatus});

  @override
  State<StatefulWidget> createState() {
    return _ShowAllVerifySellViewState();
  }
}

class _ShowAllVerifySellViewState extends State<ShowAllVerifySell> {
  late List<Seller> propList;

  Future<List<Seller>>? prop;
  String? username;
  String? photo;
  String? mobile;
  String? email;
  ...
  void initState() {
    ...
    super.initState();
    prop = SellerController.getAllBuyRequests();
    getUsername();
  }
