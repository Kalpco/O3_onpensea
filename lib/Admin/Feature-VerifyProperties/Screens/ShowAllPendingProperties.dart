...
class ShowAllPendingProperties extends StatefulWidget {
  final String screenStatus;

  ShowAllPendingProperties({super.key, required this.screenStatus});

  @override
  State<StatefulWidget> createState() {
    return _ShowAllPendingPropertiesViewState();
  }
}

class _ShowAllPendingPropertiesViewState
    extends State<ShowAllPendingProperties> {
