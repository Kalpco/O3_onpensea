...
import '../../../Property/show-alldetails/Models/bottom_navy_bar_item.dart';
import '../../../Property/show-alldetails/Models/categorical.dart';
import '../../../Property/show-alldetails/Models/numerical.dart';
import '../../../Property/show-alldetails/Models/product_category.dart';
import '../../../Property/show-alldetails/Models/product_size_type.dart';
import '../../../Property/show-alldetails/Models/recommended_product.dart';
...
class AppData {
  ...
  static List<RecommendedProduct> recommendedProducts = [
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: Colors.orangeAccent.shade700,
      //buttonBackgroundColor: const Color(0xFF9C46FF),
      buttonTextColor: Colors.orangeAccent,
    ),
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: Colors.greenAccent,
      //buttonBackgroundColor: const Color(0xFF9C46FF),
      buttonTextColor: Colors.orangeAccent,
    ),
  ];
