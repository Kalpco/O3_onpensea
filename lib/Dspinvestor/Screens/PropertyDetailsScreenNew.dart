                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ),
                      Text(
                        'Net Worth: ${tokenPrice ?? widget.prop.tokenPrice}',
                        style: GoogleFonts.poppins(
                      ...
                      const SizedBox(height: 20),
                      Text(
                        "Total Investment : ${tokenBalance ?? widget.prop.tokenBalance}",
                        style: GoogleFonts.poppins(
                          textStyle: Theme.of(context).textTheme.headlineMedium,
                          fontSize: 20,
                          color: Colors.black54,
                      ...
                      const SizedBox(height: 20),
                      Text(
                        'Mobile Number : ${widget.prop.ownerName}',
                        style: GoogleFonts.poppins(
                          textStyle: Theme.of(context).textTheme.headlineMedium,
                          fontSize: 20,
                          color: Colors.black54,
                      ...
                      const SizedBox(height: 20),
                      Text(
                        'Bank Holdings : ${widget.prop.tokenName}',
                        style: GoogleFonts.poppins(
                          textStyle: Theme.of(context).textTheme.headlineMedium,
                          fontSize: 20,
                          color: Colors.black54,
                      ...
                      // const SizedBox(height: 20),
                      // Text(
                      //   'Movie Registred Date: ${widget.prop.propRegisteredDate.split("T")[0]}',
                      //   style: GoogleFonts.poppins(
                      //     textStyle: Theme.of(context).textTheme.headlineMedium,
                      //     fontSize: 20,
                      //     color: Colors.black54,
                      ...
                      // const SizedBox(height: 20),
                      // Text(
                      //   'Movie Expired Date: ${widget.prop.propExpiredDate.split("T")[0]}',
                      //   style: GoogleFonts.poppins(
                      //     textStyle: Theme.of(context).textTheme.headlineMedium,
                      //     fontSize: 20,
                      //     color: Colors.black54,
                      ...
                      // const SizedBox(height: 20),
                      // Text(
                      //   'Director Name: ${widget.prop.directorName}',
                      //   style: GoogleFonts.poppins(
                      //     textStyle: Theme.of(context).textTheme.headlineMedium,
                      //     fontSize: 20,
                      //     color: Colors.black54,
                      ...
                      // const SizedBox(height: 20),
                      // Text(
                      //   'Actror Name: ${widget.prop.actorName}',
                      //   style: GoogleFonts.poppins(
                      //     textStyle: Theme.of(context).textTheme.headlineMedium,
                      //     fontSize: 20,
                      //     color: Colors.black54,
                      ...
                      // const SizedBox(height: 20),
                      // Text(
                      //   'Actress Name: ${widget.prop.actressName}',
                      //   style: GoogleFonts.poppins(
                      //     textStyle: Theme.of(context).textTheme.headlineMedium,
                      //     fontSize: 20,
                      //     color: Colors.black54,
